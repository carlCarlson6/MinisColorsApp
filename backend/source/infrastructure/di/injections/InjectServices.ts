...
const registerHandlers = (container: Container): Container => {
    ...
    const getAllEquivalentPaintsQueryHandler: Handler<GetAllEquivalentPaintsQuery, AllEquivalentPaints> = container.get<Handler<GetAllEquivalentPaintsQuery, AllEquivalentPaints>>("GetAllEquivalentPaintsQueryHandler");
    inMemoryServiceBus.Register(getAllEquivalentPaintsQueryHandler, "GetAllEquivalentPaintsQueryHandler");
